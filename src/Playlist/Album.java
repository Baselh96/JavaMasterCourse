...
public class Album {
    ...
    public boolean addSong(String titel, double duration){
        return songs.add(new Song(titel, duration));
    }
    ...
    private class SongList{
        ...
        private Song findSong(String titel){
            for (int i = 0; i < songs.size();i++){
                if(songs.get(i).getTitle().equals(titel)){
                    return songs.get(i);
                }
            }
            return null;
